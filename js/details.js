...
var Details = {
    ...
    qryDate: function() {
        ...
        var callback_data = {
            ...
            list: {
                radioList: [
                    {
                        title:
                            '1单选题单选题单选题单选题单选题单选题单选题单选题',
                        type: 'radio',
                        answerList: [
                            ['A. 萨达打算大三的', 'no'],
                            ['B. 让法国人哥哥二个如果', 'no'],
                            ['C. 啊实打实大苏打苏打水打算大三大四的231', 'no'],
                            ['D. 测试测试测试测试测试测试', 'yes']
                        ]
                    },
                    {
                    ...
                    {
                        title:
                            '2单选题单选题单选题单选题单选题单选题单选题单选题',
                        type: 'radio',
                        answerList: [
                            ['萨达打算大三的', 'no'],
                            ['让法国人哥哥二个如果', 'no'],
                            ['啊实打实大苏打苏打水打算大三大四的231', 'no']
                        ]
                    }
                ],
                checkboxList: [
                ...
                trueOrFalseList: [
                    {
                        title:
                            '1选择题选择题选择题选择题选择题选择题选择题选择题选择题选择题选择题',
                        type: 'trueOrFalse',
                        answerList: [['正确', 'no'], ['错误', 'yes']]
                    },
                    {
                        title:
                            '2选择题选择题选择题选择题选择题选择题选择题选择题选择题选择题选择题',
                        type: 'trueOrFalse',
                        answerList: [['正确', 'no'], ['错误', 'yes']]
                    },
                    {
                        title:
                            '3选择题选择题选择题选择题选择题选择题选择题选择题选择题选择题选择题',
                        type: 'trueOrFalse',
                        answerList: [['正确', 'no'], ['错误', 'yes']]
                    },
                    {
                        title:
                            '4选择题选择题选择题选择题选择题选择题选择题选择题选择题选择题选择题',
                        type: 'trueOrFalse',
                        answerList: [['正确', 'no'], ['错误', 'yes']]
                    },
                    {
                        title:
                            '5选择题选择题选择题选择题选择题选择题选择题选择题选择题选择题选择题',
                        type: 'trueOrFalse',
                        answerList: [['正确', 'no'], ['错误', 'yes']]
                    },
                    {
                        title:
                            '6选择题选择题选择题选择题选择题选择题选择题选择题选择题选择题选择题',
                        type: 'trueOrFalse',
                        answerList: [['正确', 'no'], ['错误', 'yes']]
                    },
                    {
                        title:
                            '7选择题选择题选择题选择题选择题选择题选择题选择题选择题选择题选择题',
                        type: 'trueOrFalse',
                        answerList: [['正确', 'no'], ['错误', 'yes']]
                    },
                    {
                        title:
                            '8选择题选择题选择题选择题选择题选择题选择题选择题选择题选择题选择题',
                        type: 'trueOrFalse',
                        answerList: [['正确', 'no'], ['错误', 'yes']]
                    },
                    {
                        title:
                            '9选择题选择题选择题选择题选择题选择题选择题选择题选择题选择题选择题',
                        type: 'trueOrFalse',
                        answerList: [['正确', 'no'], ['错误', 'yes']]
                    },
                    {
                        title:
                            '10选择题选择题选择题选择题选择题选择题选择题选择题选择题选择题选择题',
                        type: 'trueOrFalse',
                        answerList: [['正确', 'no'], ['错误', 'yes']]
                    }
                ]
        ...
        if (get_cache_form) {
            ...
            var get_exam_form_finish = window.localStorage.getItem(
                'exam_form_finish'
            );
            if (get_exam_form_finish == '2') {
                ...
                $('li').each(function(i) {
                    ...
                    $('.is-cor').show();
                    if (radio_answer) {
                        correctNum = radio_answer.substr(
                            radio_answer.length - 1,
                            1
                        );
    ...
    getPerScore: function(correct) {
        ...
        $.confirm(
            '答对' + correct + '道题；' + '获得' + correct + '分',
            '提交成功!',
            function() {
                window.localStorage.setItem('exam_form_finish', '2');
